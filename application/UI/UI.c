...
static void DeterminRobotID()
{
    ...
    if (referee_info.GameRobotState.robot_id > 7) {
        target_outpost = referee_info.GameRobotHP.red_outpost_HP;
    } else {
        target_outpost = referee_info.GameRobotHP.blue_outpost_HP;
    }
}
